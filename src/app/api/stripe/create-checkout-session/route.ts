...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ error: `Failed to create checkout session: ${errorMessage}. Please check server logs for detailed error information, especially regarding environment variable configuration.` }, { status: 500 });
  }
}
